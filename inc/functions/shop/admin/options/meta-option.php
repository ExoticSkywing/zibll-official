        ...
        'fields' => array(
            ...
            array(
                ...
                'fields'     => array(
                    ...
                    array(
                        ...
                        'title'      => '卡密备注',
                        'subtitle'   => '根据备注筛选卡密',
                        'desc'       => '如还未创建，请先创建后在此处输入卡密的备注 | <a target="_blank" href="' . admin_url('admin.php?page=zibpay_charge_card_page') . '">管理卡密</a> | <a target="_blank" href="' . admin_url('admin.php?page=zibpay_coupon_page') . '">管理优惠码</a>',
                        'default'    => '',
                    ),
                    array(
            ...
            array(
                ...
                <div class="c-yellow"><b>注意事项：</b>
                    ...
                    <li>2.如果选择卡密，填写对应的备注以搜索并发送给给用户，如未创建卡密，则需先创建</li>
                    <li>3.选择卡密时，同时支持卡密和优惠码，选择邀请码时，支持自动创建或填写备注来选择已创建的邀请码</li>
