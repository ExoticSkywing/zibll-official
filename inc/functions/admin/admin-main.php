 ...
 * @LastEditTime : 2025-11-28 12:50:04
...
function zib_admin_environmental_dependence_reminders()
{
    ...
    if (!extension_loaded('curl')) {
        $error .= '<p>PHP缺少<code>curl</code>基础组件，将会导致部分功能无法使用！ <a href="https://www.zibll.com/forum-post/41851.html" target="_blank">查看安装教程</a></p>';
    }
