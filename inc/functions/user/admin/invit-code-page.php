 ...
 * @LastEditTime : 2025-11-25 15:59:46
 */
...
switch ($tab) {
    ...
    case 'add':
        ...
        $csf_fields[] = array(
            ...
            <li>如果使用的是单密码模式，卡号部分随便填什么都行，但不能留空</li>',
            'style'      => 'warning',
            'type'       => 'submessage',
        );
        $csf_fields[] = array(
    ...
    default: //文章类型的
        ...
        if ($db_data) {
            ...
            foreach ($db_data as $msg) {
                ...
                $tbody .= "<td><span data-clipboard-text='$msg->password' data-clipboard-tag='邀请码'>$msg->password</span></td>";
